...
if __name__ == "__main__":
    ...
    # Logging settings
    # china time
    china_time = datetime.datetime.now() - datetime.timedelta(hours=8)
    parser.add_argument("--logging_dir", type=str, default="./output/" + str(date.today()) + "_" + str(china_time.strftime("%H:%M:%S")) + "/",
